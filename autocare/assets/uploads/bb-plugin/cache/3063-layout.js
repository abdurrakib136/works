...
$('.uabb-row-separator').parents('html').css('overflow-x','hidden');});var wpAjaxUrl='https://ep.trendboutique.co.uk/wp-admin/admin-ajax.php';var flBuilderUrl='https://ep.trendboutique.co.uk/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'https://ep.trendboutique.co.uk/wp-content/plugins/bb-plugin/',wpAjaxUrl:'https://ep.trendboutique.co.uk/wp-admin/admin-ajax.php'},breakpoints:{small:768,medium:992},waypoint:{offset:80}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
if(jQuery('body').hasClass('fl-builder-edit')&&this.small_device<30){jQuery('body').find(node).addClass('uabb-mobile-spacer-height-adjustment');}},};})(jQuery);jQuery(document).ready(function(){new UABBSpacerGap({id:'5c1384b968d1d',desktop_space:'140',medium_device:'100',small_device:'80',});});jQuery(document).ready(function(){new UABBSpacerGap({id:'5c1384b968ce2',desktop_space:'150',medium_device:'80',small_device:'50',});});jQuery(document).ready(function(){new UABBSpacerGap({id:'5c1384b9692c6',desktop_space:'40',medium_device:'20',small_device:'5',});});jQuery(document).ready(function(){new UABBSpacerGap({id:'5c1384b969638',desktop_space:'0',medium_device:'0',small_device:'20',});});jQuery(document).ready(function(){new UABBSpacerGap({id:'5c1384b969210',desktop_space:'0',medium_device:'20',small_device:'10',});});jQuery(document).ready(function(){new UABBSpacerGap({id:'5c1384b969498',desktop_space:'40',medium_device:'20',small_device:'',});});jQuery(document).ready(function(){new UABBSpacerGap({id:'5c1384b969508',desktop_space:'40',medium_device:'20',small_device:'',});});;(function($){var form=$('.fl-builder-settings'),gradient_type=form.find('input[name=uabb_row_gradient_type]');$(document).on('change','input[name=uabb_row_radial_advance_options], input[name=uabb_row_linear_advance_options], input[name=uabb_row_gradient_type], select[name=bg_type]',function(){var form=$('.fl-builder-settings'),background_type=form.find('select[name=bg_type]').val(),linear_direction=form.find('select[name=uabb_row_uabb_direction]').val(),linear_advance_option=form.find('input[name=uabb_row_linear_advance_options]:checked').val(),radial_advance_option=form.find('input[name=uabb_row_radial_advance_options]:checked').val(),gradient_type=form.find('input[name=uabb_row_gradient_type]:checked').val();if(background_type=='uabb_gradient'){if(gradient_type=='radial'){setTimeout(function(){form.find('#fl-field-uabb_row_linear_direction').hide();form.find('#fl-field-uabb_row_linear_gradient_primary_loc').hide();form.find('#fl-field-uabb_row_linear_gradient_secondary_loc').hide();},1);if(radial_advance_option=='yes'){form.find('#fl-field-uabb_row_radial_gradient_primary_loc').show();form.find('#fl-field-uabb_row_radial_gradient_secondary_loc').show();}}
